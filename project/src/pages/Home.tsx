    ...
    <div className="p-6 text-white">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {[
            { name: 'Pop', color: 'from-pink-500 to-rose-500', image: 'https://images.pexels.com/photos/1105666/pexels-photo-1105666.jpeg?auto=compress&cs=tinysrgb&w=300', query: 'pop' },
            { name: 'Rock', color: 'from-red-500 to-orange-500', image: 'https://images.pexels.com/photos/1699030/pexels-photo-1699030.jpeg?auto=compress&cs=tinysrgb&w=300', query: 'rock' },
            { name: 'Electronic', color: 'from-blue-500 to-cyan-500', image: 'https://images.pexels.com/photos/1763075/pexels-photo-1763075.jpeg?auto=compress&cs=tinysrgb&w=300', query: 'electronic' },
            { name: 'Jazz', color: 'from-purple-500 to-indigo-500', image: 'https://images.pexels.com/photos/1105666/pexels-photo-1105666.jpeg?auto=compress&cs=tinysrgb&w=300', query: 'jazz' },
            { name: 'Classical', color: 'from-green-500 to-teal-500', image: 'https://images.pexels.com/photos/1699030/pexels-photo-1699030.jpeg?auto=compress&cs=tinysrgb&w=300', query: 'classical' }
          ].map((genre) => (
            <div
              key={genre.name}
              onClick={() => navigate(`/search?q=${genre.query}`)}
