...
export const Search = () => {
  ...
  useEffect(() => {
    // Verificar si hay un query parameter en la URL
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
            {[
              ...
              { name: 'world', color: 'from-yellow-500 to-orange-500' },
              { name: 'soundtrack', color: 'from-violet-500 to-purple-500' }
            ].map((category) => (
              <button
                key={category.name}
              ...
              >
                <h3 className="text-white font-bold text-lg capitalize">{category.name}</h3>
              </button>
            ))}
          </div>
        </section>
